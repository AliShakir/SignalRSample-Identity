...
connection.on("ReceiveDeleteRoomMessage", function (deleted, selected, roomName, userName) {
    ...
    addMessage(`${userName} has deleted ${roomName}`);
    fillRoomDropDown();
});
//
...
function addnewRoom(maxRoom) {
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            connection.invoke("SenAddRoomMessage",maxRoom,json.id,json.name)
...
function deleteRoom() {
    ...
    let text = `Do you want to delete Chat Book ${roomName}`
